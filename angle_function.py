...
def calculate_angle(coord_df, female=True, male=True):
    ...
    if female == True:
        fem_ear_diff_x = ( coord_df['female_right_ear_x'] + coord_df['female_left_ear_x'] ) / 2  # midpoint
        fem_ear_diff_y = ( coord_df['female_right_ear_y'] + coord_df['female_left_ear_y'] ) / 2
    ...
    if male == True:
        male_ear_diff_x = ( coord_df['male_right_ear_x'] + coord_df['male_left_ear_x'] ) / 2  # midpoint
        male_ear_diff_y = ( coord_df['male_right_ear_y'] + coord_df['male_left_ear_y'] ) / 2
